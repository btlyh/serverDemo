...
public class CRC32
{
	...
	public static int getCRC32(String str)
	{
		...
		// }
		// crc=crc^0xffffffff;
		// // System.err.println("CRC32 = "+Integer.toHexString(crc));
		// return crc;
	...
	public static int getValue(byte[] bytes,int start,int length)
	{
		return getValue(bytes,start,length,0xFFFFFFFF)^0xFFFFFFFF;
	}

	public static int getValue(byte[] bytes,int start,int length,int crc)
	{
		for(int i=0;i<length;i++)
		{
			crc=(crc>>>8^TABLE[(crc^bytes[start+i])&0xff]);
		}
		return crc;
	}
	/* fields */
